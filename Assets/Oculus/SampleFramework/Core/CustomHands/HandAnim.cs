...
public class HandAnim : MonoBehaviour
{
  ...
  private float thumbCap_state = 0f;
    ...
    void Update()
    {
        ...
        m_animator.SetFloat("trigger", controller.selectAction.action.ReadValue<float>());
        //m_animator.SetFloat("grip", controller.activateAction.action.ReadValue<float>());
        //m_animator.SetFloat("button", controller.uiPressAction.action.ReadValue<float>());
        //m_animator.SetFloat("Flex", controller..action.ReadValue<float>());
